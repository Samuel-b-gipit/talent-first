...
import { Plus, X, MapPin, DollarSign, Clock, User, Camera } from "lucide-react";
...
export default function CreateProfilePage() {
  ...
  useEffect(() => {
    if (!user) return;
    talentsApi.getById(user.id).then(({ data }) => {
      if (data) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { data, error: apiError } = profileId
      ? await talentsApi.update(profileId, payload)
      : await talentsApi.create(payload);
    ...
    router.push(
      profileId ? `/profile/${data?.userId ?? user?.id}` : "/proposals",
    );
  };
        ...
        <div className="container mx-auto px-6 py-10 max-w-4xl">
          <div className="mb-10 animate-fade-in">
            ...
            <p className="text-muted-foreground text-lg">
              Showcase your skills and experience to attract the right
              opportunities
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Tell employers who you are and what you do
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Let employers know your availability and preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("openToContract", checked)
                      }
                    />
                  </div>
                </div>
            ...
            <div className="flex gap-4">
              ...
              >
                {(() => {
                  if (isLoading)
                    return profileId ? "Saving..." : "Creating Profile...";
                  return profileId ? "Save Changes" : "Create Profile";
                })()}
              </Button>
