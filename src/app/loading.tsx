  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          <h1 className="text-5xl font-bold text-foreground mb-6 text-balance">
            Where Top Talent Gets <span className="text-primary">Discovered</span>
          </h1>
          <p className="text-xl text-muted-foreground mb-8 text-pretty">
            The reverse job board where talented professionals showcase their skills and employers compete for their
            attention with personalized proposals.
          </p>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input placeholder="Search for developers, designers, marketers..." className="pl-12 py-6 text-lg" />
              <Button className="absolute right-2 top-1/2 transform -translate-y-1/2">Search Talent</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">How TalentFirst Works</h2>
            <p className="text-muted-foreground text-lg">A simple process that puts talent in control</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Showcase your skills, experience, and what you're looking for in your next role.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Employers browse profiles and send personalized proposals directly to you.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">3. Choose Your Next Role</h3>
              <p className="text-muted-foreground">
                Review proposals, chat with employers, and select the opportunity that's right for you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">The reverse job board where talent comes first.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  <Link href="/browse-proposals" className="hover:text-foreground transition-colors">
                    Browse Proposals
                  </Link>
                </li>
                <li>
                  <Link href="/talent-resources" className="hover:text-foreground transition-colors">
                    Resources
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  <Link href="/browse-talent" className="hover:text-foreground transition-colors">
                    Browse Talent
                  </Link>
                </li>
                <li>
